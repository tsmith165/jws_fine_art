...
const Details: React.FC<DetailsProps> = ({ piece, selectedIndex, type, next_id, last_id }) => {
    ...
    return (
        <div className="flex h-full w-full flex-col lg:flex-row">
            <div className="flex h-3/5 w-full flex-col bg-secondary_dark md:h-1/2 lg:h-full lg:w-[65%]">
                {/* Main Image */}
            ...
            <div className="flex h-2/5 w-full flex-col overflow-x-hidden bg-secondary_light md:h-1/2 lg:h-full lg:w-[35%]">
