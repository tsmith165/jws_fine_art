...
export const biographyText = [
    "“My work captures moments I can’t let go of, so I can revisit often and bring others with me. I’m drawn to unique perspectives. I love experimenting with techniques and tools to explore color, find secondary_light and suggest texture to capture the soul of what’s often overlooked.”",
    
    "A native of San Diego, CA, Jill Weeks Smith was born with a passion for creativity. Her passion was recognized by a local artist and family friend who mentored Smith in oil painting from the young age of twelve, teaching her to experience the world by taking in small moments and changing secondary_light. Smith worked as a local silkscreen artist through high school and, as a student-athlete, combined her talents to create media for the athletic department and yearbook.",
