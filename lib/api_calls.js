...
async function edit_details({
    id, title, description, type, sold, price, instagram, width, height, real_width, real_height, theme, available, framed, comments,
}) {
    console.log(`Editing Details for piece ${id}...`);
    console.log(
        `Setting piece to Sold: ${sold} | Title: ${title} | Theme: ${theme} | Available: ${available} | Instagram: ${instagram} | Framed: ${framed} | Comments: ${comments}`,
    );
...
async function create_piece({
    title, description, type, sold, price, instagram, width, height, real_width, real_height, image_path, theme, available, framed, comments,
}) {
