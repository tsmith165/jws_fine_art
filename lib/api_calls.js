...
async function create_stripe_checkout_session(data) {
    const {
        piece_db_id, piece_o_id, piece_title, image_path, width, height, price, full_name, phone, email, address, international,
    } = data;
...
async function create_pending_transaction(data) {
    const {
        piece_db_id, piece_title, full_name, phone, email, address, international
    } = data;
