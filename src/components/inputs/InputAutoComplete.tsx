                            ...
                            <div className="m-auto flex w-[calc(100vw-40px)] flex-col px-2.5 md:w-[calc(100%-40px)]">
                                {suggestions.map((suggestion: Suggestion) => {
                                    ...
                                    const suggestionItemProps: ReturnType<typeof getSuggestionItemProps> = getSuggestionItemProps(
                                        suggestion,
                                        'h-8 px-2.5 text-secondary_dark bg-primary rounded-b-md border-none font-bold placeholder-secondary text-stone-900 overflow-hidden overflow-ellipsis whitespace-nowrap ',
                                    );
                                    return (
                                        <div
                                            className="h-8 overflow-hidden overflow-ellipsis whitespace-nowrap bg-primary px-2.5 pt-2 leading-8 text-secondary_dark last:rounded-b-md last:pb-2 hover:bg-secondary_dark hover:text-primary"
                                            {...suggestionItemProps}
                                        >
